...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#c0c0c0] flex items-center justify-center p-8">
      <div className="max-w-6xl w-full">
        <div className="bg-[#0a0a0a] border-2 border-[#1a1a1a] shadow-lg p-8">
          <h1
            className="text-4xl font-bold text-[#e0e0e0] mb-2 tracking-wider text-center"
            style={{ fontFamily: '"Press Start 2P", "DOS NODE", monospace' }}
          >
            DUAL NFT COLLECTION VIEWERS
          </h1>
          <p
            className="text-[#888] text-center mb-8"
            style={{ fontFamily: '"Press Start 2P", "DOS NODE", monospace' }}
          >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/koda-viewer">
              <div className="bg-[#1a1a1a] border-2 border-[#2a2a2a] p-6 cursor-pointer transition-all hover:border-[#ff8c00] hover:scale-[1.02]">
                <div className="text-center mb-4">
                  ...
                  <p
                    className="text-[#888] text-sm mb-4"
                    style={{
                      fontFamily:
                        '"Share Tech Mono", "Orbitron", "Courier New", monospace',
                      fontWeight: "700",
                  ...
                  <div
                    className="inline-block px-6 py-2 bg-[#ff8c00] text-white text-sm"
                    style={{
                      fontFamily:
                        '"Share Tech Mono", "Orbitron", "Courier New", monospace',
                      fontWeight: "700",
